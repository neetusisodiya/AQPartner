...
public class LoginBean {
    ...
    private String upload_exp_cert;
    private String joining_file;
    ...
    public String getUpload_exp_cert() {
        return upload_exp_cert;
    }

    public void setUpload_exp_cert(String upload_exp_cert) {
        this.upload_exp_cert = upload_exp_cert;
    }

    public String getJoining_file() {
        return joining_file;
    }

    public void setJoining_file(String joining_file) {
    ...
    public String getExpert_type_id() {
        return expert_type_id;
    }

    public void setExpert_type_id(String expert_type_id) {
        this.expert_type_id = expert_type_id;
    }

    public String getWorking_radius() {
        return working_radius;
    }

    public void setWorking_radius(String working_radius) {

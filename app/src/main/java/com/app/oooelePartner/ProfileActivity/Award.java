...
public class Award extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonChoose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ActivityCompat.requestPermissions(Award.this, new String[]
            ...
            public void onClick(View v) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, uploadeUrl, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(Award.this, response, Toast.LENGTH_SHORT).show();
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Award.this, "Error" + error, Toast.LENGTH_SHORT).show();
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(Award.this);
    ...
    void init() {
        buttonChoose = findViewById(R.id.selectAw);
        buttonUpload = findViewById(R.id.submit_Award);
        imageView = findViewById(R.id.imageAw);
